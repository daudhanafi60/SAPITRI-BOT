...
//
const BotName = 'SAPITRI BOT''🤖'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/ridho_setiawan02'; // Nama Instagramlu cok
const whatsapplu = '0812-1679-5577'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1https:'//chat.whatsapp.com/JytoxZ3Xi7k5TJJEtsrZdP'OFFICIAL GRUP LU 1
